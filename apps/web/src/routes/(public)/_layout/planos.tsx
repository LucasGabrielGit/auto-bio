...
function PlanosComponent() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "O plano gratuito é permanente e inclui 1 bio e 3 links. Você pode fazer upgrade quando quiser."
    },
    {
    ...
    },
    {
      ...
      answer: "Sim, no plano Premium você pode usar seu próprio domínio (ex: meubio.com) sem custos extras."
    },
    {
      question: "Como funciona a IA para criar bios?",
      answer: "Nossa IA analisa seu perfil profissional e gera bios personalizadas. Você pode editar e regenerar quantas vezes quiser."
    }
  ]
                ...
                <div className="space-y-3">
                  ...
                  {plan.limitations.length > 0 && (
                    <div className="pt-3 border-t">
                      <p className="font-semibold text-sm text-muted-foreground mb-2">Não incluído:</p>
      ...
      >
        ...
        <div className="overflow-x-auto">
          <table className="w-full border-collapse">
            ...
            <tbody>
              {[
                { feature: "Bios com IA", free: "1", pro: "Ilimitado", premium: "Ilimitado" },
                { feature: "Links personalizados", free: "3", pro: "Ilimitado", premium: "Ilimitado" },
                { feature: "Layouts disponíveis", free: "1 básico", pro: "5 extras", premium: "10+ exclusivos" },
                { feature: "Domínio próprio", free: "×", pro: "×", premium: "✓" },
                { feature: "Relatórios", free: "×", pro: "Básicos", premium: "Avançados" },
                { feature: "IA de tradução", free: "×", pro: "×", premium: "✓" },
                { feature: "Suporte", free: "Email", pro: "Prioritário", premium: "VIP 24/7" }
              ].map((row, index) => (
