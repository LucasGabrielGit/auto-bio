    ...
    <div className="container mx-auto py-8 px-4 max-w-6xl">
      ...
      >
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Editar Biografia</h1>
          ...
          <form onSubmit={handleSubmit((data) => onSubmit(data, false))} className="space-y-6">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <Switch
                      ...
                      {...register('isPublic')}
                    />
                    <Label htmlFor="isPublic">Tornar biografia pública</Label>
                  </div>
                </CardContent>
              </Card>
            </motion.div>
                      ...
                      <div key={field.id} className="flex space-x-2 items-center">
                        ...
                        <div className="flex-1">
                          ...
                          {errors.links?.[index]?.url && (
                            <p className="text-xs text-destructive mt-1">{errors.links[index]?.url?.message}</p>
                          )}
                        </div>
                        <Button
                          type="button"
            ...
            <div className="flex justify-between">
              ...
              <div className="space-x-2">
                ...
                <Button
                  type="button"
                  onClick={handleSubmit((data) => onSubmit({ ...data, isPublic: true }))}
              ...
              <CardContent className="space-y-4">
                <div className="p-4 bg-muted/50 rounded-lg">
                  ...
                  <div className="text-sm text-muted-foreground mb-3">
                    <Markdown>
                      {watch('content') || 'Conteúdo da biografia aparecerá aqui...'}
                    </Markdown>
                  </div>
                  {watch('style') && (
                    <Badge variant="outline" className="text-xs">
                      {bioStyles.find(s => s.value === watch('style'))?.label}
                    </Badge>
                  )}
                </div>
                ...
                {fields.length > 0 && (
                  <div className="space-y-2">
                    ...
                    {fields
                      .filter((_, index) => watch(`links.${index}.label`) && watch(`links.${index}.url`))
                      .map((field, index) => (
                        <div key={field.id} className="flex items-center space-x-2 text-sm">
                          <LinkIcon className="h-3 w-3" />
                          <span className="text-muted-foreground">{watch(`links.${index}.label`)}</span>
                        </div>
                      ))}
                  </div>
                )}
